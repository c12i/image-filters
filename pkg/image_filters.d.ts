...
* @returns {Uint8Array}
*/
  apply_filter(filter_name: string): Uint8Array;
}
/**
...
export interface InitOutput {
  ...
  readonly __wbg_imageprocessor_free: (a: number) => void;
  readonly imageprocessor_new: (a: number, b: number, c: number, d: number) => number;
  readonly imageprocessor_apply_filter: (a: number, b: number, c: number, d: number) => void;
