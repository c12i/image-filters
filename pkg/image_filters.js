...
export class ImageProcessor {
    ...
    free() {
        ...
        wasm.__wbg_imageprocessor_free(ptr);
    }
    /**
    ...
    */
    constructor(data, width, height) {
        ...
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.imageprocessor_new(ptr0, len0, width, height);
    ...
    */
    apply_filter(filter_name) {
        try {
            ...
            var ptr0 = passStringToWasm0(filter_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.imageprocessor_apply_filter(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('image_filters_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_drawImage_9e2d13329d92a0a3 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
