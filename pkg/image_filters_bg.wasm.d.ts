...
export function __wbg_imageprocessor_free(a: number): void;
export function imageprocessor_new(a: number, b: number, c: number, d: number): number;
export function imageprocessor_apply_filter(a: number, b: number, c: number, d: number): void;
